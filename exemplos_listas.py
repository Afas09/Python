...
# EXEMPLO 2
#
# Considere a lista abaixo e escreva um programa que 
# multiplique todos os seus elementos.
lista=[5,4,3,2,1]
...
# na tela o seu maior e menor número.
lista=[5,43,3,2,10]
maior = max(lista)
menor = min(lista)
#################################################################################################################################################################
...
# EXEMPLO 4
#
# Ordene os elementos das listas a seguir: a primeira em ordem 
# crescente e a segunda em ordem decrescente.
...
# FATIAMENTO
print(lista_anos[:20]) # Alínea A
print(lista[20:])
print(lista_anos.index(1923))
print(lista_anos[lista_anos.index(1937):lista_anos.index(1970)]) # Alínea B
print(lista_anos[-1]) # Último elemento da lista # Alínea C
print(lista_anos[::10]) # Alínea D
